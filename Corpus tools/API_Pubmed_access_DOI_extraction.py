...
Entrez.email = " " #insert email address 
...
query = '(((bioinformatics) OR (computational biology)) AND (French[Language]))' #change query if needed
retmax = 300 #change value if needed
